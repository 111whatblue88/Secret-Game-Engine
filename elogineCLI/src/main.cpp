...
void printHelp() {
    ...
    std::cout << "options are: -n {NAME} - doesnt ask for a name and uses this provided one. -b - creates a bare project, no CMakeListsFile or other helpers.\n";
    std::cout << "project delete - promps you to delete a project.\n";
    std::cout << "options are: -n {NAME} - doesnt ask for a name and uses this provided one instead.\n";
    std::cout << "project {NAME} build - builds the given project with the CMakeLists file \n";
    std::cout << "options are: -c - builds clean, deletes the previous build files.  \n";
    std::cout << "project {NAME} run - runs the given project \n";
    std::cout << "project {NAME} version - fetches the version from the version file in the project \n";
