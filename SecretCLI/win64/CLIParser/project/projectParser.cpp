...
bool ProjectParser::parseArguments() {
  ...
  if (projectParser.is_subcommand_used("build")) {
    ...
    printColor("Copying DLLs...\n", color::green);

    fs::current_path(fs::current_path()/"bin");

    filesystem::execCommand("COPY ..\\..\\..\\..\\engine\\vendored\\SDL\\src\\build\\Debug\\SDL3.dll .\\");
    ...
    filesystem::execCommand("COPY ..\\..\\..\\..\\engine\\vendored\\Secret-Output-Helper\\build\\bin\\Debug\\Secret-Output-Helper.dll .\\");
